...
export class YuToastService {
  
  public showToastOverElement(action: ToastAction, targetElement: HTMLElement): void {
...
export const yuToastService = new YuToastService();